...
| 面 | 中身 |
|---|---|
| 見る | ギャラリー・写真詳細・関連写真・タグ/撮影地/カテゴリの絞り込み・地図・年表・検索 |
| 書く | カメラ撮影・ライブラリから投稿・写真の編集・下書き（非公開）・プロフィール編集（アイコン/カバー） |
| つながる | いいね・コメント・フォロー・お知らせ・ストーリー（閲覧/返信/見た人/残す）・アルバム（招待リンク） |
| 安全 | 規約への同意・通報・ブロックと解除・アカウント削除 |
| 支える | オフライン表示・お気に入り・曲の30秒試聴 |

まだ無いもの: **プッシュ通知**（サーバー側の APNs 一式が無いため）、
動画のストーリー投稿、共同アルバムへの写真追加 UI。
